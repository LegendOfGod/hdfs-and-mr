...
public class OrderJobMain extends Configured implements Tool {
    public int run(String[] strings) throws Exception {
        ...
        TextInputFormat.addInputPath(job,new Path("hdfs://172.24.250.142:8020/order"));
        //mapper
        ...
        TextOutputFormat.setOutputPath(job,new Path("hdfs://172.24.250.142:8020/order_out"));
